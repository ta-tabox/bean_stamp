...
ActiveRecord::Schema.define(version: 20_220_210_130_742) do
  ...
  create_table 'bean_taste_tags', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[bean_id mst_taste_tag_id], name: 'index_bean_taste_tags_on_bean_id_and_mst_taste_tag_id', unique: true
  ...
  create_table 'beans', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[roaster_id created_at], name: 'index_beans_on_roaster_id_and_created_at'
  ...
  create_table 'offers', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[bean_id created_at ended_at], name: 'index_offers_on_bean_id_and_created_at_and_ended_at'
  ...
  create_table 'roaster_relationships', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[follower_id roaster_id], name: 'index_roaster_relationships_on_follower_id_and_roaster_id', unique: true
  ...
  create_table 'wants', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    ...
    t.index %w[user_id offer_id], name: 'index_wants_on_user_id_and_offer_id', unique: true
