MstCountry.seed(
  ...
  { id: 16, name: 'ニカラグア', area: 'Latin America' },
  { id: 17, name: 'タンザニア', area: 'Africa' },
  { id: 18, name: 'タイ', area: 'Asia' },
  { id: 19, name: 'パプアニューギニア', area: 'Oceania' },
  { id: 20, name: 'ケニア', area: 'Africa' },
  { id: 21, name: 'エルサルバドル', area: 'Latin America' },
  { id: 22, name: 'ベネズエラ', area: 'Latin America' },
  { id: 23, name: 'マダガスカル', area: 'Africa' },
  { id: 24, name: 'カメルーン', area: 'Africa' },
  { id: 25, name: 'フィリピン', area: 'Asia' },
  { id: 26, name: 'ラオス', area: 'Asia' },
  { id: 27, name: 'エクアドル', area: 'Latin America' },
  { id: 28, name: 'ドミニカ共和高', area: 'Latin America' },
  { id: 29, name: 'ハイチ', area: 'Latin America' },
  { id: 30, name: 'ルワンダ', area: 'Africa' },
  { id: 31, name: 'コンゴ民主共和国', area: 'Africa' },
  { id: 32, name: 'ブルンジ', area: 'Africa' },
  { id: 33, name: 'イエメン', area: 'Asia' },
  { id: 34, name: 'ボリビア', area: 'Latin America' },
  { id: 35, name: 'キューバ', area: 'Latin America' },
